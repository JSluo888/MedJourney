...
exports.ValidationHelper = exports.ErrorHandler = exports.FileUploadError = exports.AIServiceError = exports.DatabaseError = exports.ServiceUnavailableError = exports.RateLimitError = exports.ConflictError = exports.ForbiddenError = exports.UnauthorizedError = exports.NotFoundError = exports.ValidationError = exports.CustomError = void 0;
// 自定义错误类
...
class ErrorHandler {
    ...
    // 将错误转换为API响应格式
    static toApiResponse(error, requestId) {
        if (error instanceof CustomError) {
            return {
                success: false,
                error: {
...
class ValidationHelper {
    ...
    // 验证数组
    static array(value, fieldName, minLength = 0, maxLength) {
