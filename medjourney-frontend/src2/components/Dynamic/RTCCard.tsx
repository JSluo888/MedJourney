...
import AgentVoicePresetSelect from "../Agent/VoicePresetSelect"
import AgentView from "../Agent/View"
import Avatar from "../Agent/AvatarTrulience"
import MicrophoneBlock from "../Agent/Microphone"
import VideoBlock from "../Agent/Camera"
...
export default function RTCCard(props: { className?: string }) {
  ...
  const DynamicChatCard = dynamic(() => import("../Chat/ChatCard"), {
    ssr: false,
  });
